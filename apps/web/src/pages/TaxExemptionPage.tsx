      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            All charities on TankBet are registered 501(c)(3) nonprofit organizations. Donations
            made through TankBet may be tax-deductible to the extent permitted by law.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            your year-to-date donations on TankBet. You can use this as a reference when preparing
        ...
        <section>
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            the 501(c)(3) organization itself is the issuing authority — TankBet records serve as a
            personal reference.
          </p>
        </section>

        <p className="text-xs text-slate-600 pt-2">
          TankBet is not a tax advisor. Consult a qualified tax professional for advice specific to your situation.
        </p>
      </div>
    </div>
  );
