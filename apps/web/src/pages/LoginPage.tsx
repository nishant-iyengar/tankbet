    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 w-full h-full">
          <h1 className="text-3xl font-bold text-cyan-400 tracking-tight mb-6">Tank Battle</h1>
      ...
      <div className="w-full lg:w-1/2 xl:w-[45%] flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden mb-10 text-center">
            <h1 className="text-3xl font-bold text-cyan-400 tracking-tight">Tank Battle</h1>
          </div>
